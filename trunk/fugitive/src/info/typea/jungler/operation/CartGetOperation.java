 ...
 */
public class CartGetOperation extends Operation {
	/** required fields */
	protected final String[] REQUIRED_FIELDS = {"CartId", "HMAC"};
	/** available ResponseGroups */
	public enum CARTGET_RESPONSEGROUP {Request, Cart, CartSimilarities, CartTopSellers, CartNewReleases};
	/** Constructor */
	public CartGetOperation() {
		setParameter("Operation","CartGet");
	}
	...
	/** set ResponseGroup */
	public void setResponseGroup(CARTGET_RESPONSEGROUP responseGroup) {
