 ...
 */
public class CartCreateOperation extends Operation {
	/** required fields */
	protected final String[] REQUIRED_FIELDS = {"AssociateTag", "Items"};
	/** available ResponseGroups */
	public enum CARTCREATE_RESPONSEGROUP {Request, Cart, CartSimilarities, CartTopSellers, CartNewReleases};
	/** Constructor */
	public CartCreateOperation() {
		setParameter("Operation","CartCreate");
	}
	...
	/** set ResponseGroup */
	public void setResponseGroup(CARTCREATE_RESPONSEGROUP responseGroup) {
