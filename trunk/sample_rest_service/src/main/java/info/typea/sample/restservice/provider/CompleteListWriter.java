 ...
 */
@Provider
public class CompleteListWriter implements MessageBodyWriter<CompleteList> {
	//private static final Logger logger = LoggerFactory.getLogger(CompleteListWriter.class);
	private JAXBContext jaxbContext;
	
	public long getSize(CompleteList completeList, 
			Class<?> type, 
			Type genericType,  
	...
	public boolean isWriteable(Class<?> type, 
		...
		return type.equals(CompleteList.class);
	}
	 ...
	 */
	public void writeTo(CompleteList completeList, Class<?> type, 
			Type genericType, 
			Annotation[] annotation, 
			MediaType mediaType, 
		...
		try {
			...
			mshr.marshal(completeList, writer);
