 ...
 */
public class CartClearOperation extends Operation {
	/** required fields */
	protected final String[] REQUIRED_FIELDS = {"CartId", "HMAC"};
	/** available ResponseGroups */
	public enum CARTCLEAR_RESPONSEGROUP {Request, Cart};
	/** Constructor */
	public CartClearOperation() {
		setParameter("Operation","CartClear");
	}
	...
	/** set ResponseGroup */
	public void setResponseGroup(CARTCLEAR_RESPONSEGROUP responseGroup) {
