 ...
 */
public class SellerLookupOperation extends Operation {
	/** required fields */
	protected final String[] REQUIRED_FIELDS = {"SellerId"};
	/** available ResponseGroups */
	public enum SELLERLOOKUP_RESPONSEGROUP {Request, Seller};
	/** Constructor */
	public SellerLookupOperation() {
		setParameter("Operation","SellerLookup");
	}
	...
	/** set ResponseGroup */
	public void setResponseGroup(SELLERLOOKUP_RESPONSEGROUP responseGroup) {
	...
	public void setFeedbackPage(String[] feedbackPage) {
		setParameter("FeedbackPage", feedbackPage);
	}
	public void setFeedbackPage(String feedbackPage) {
		setParameter("FeedbackPage", feedbackPage);
	}
	public String[] getFeedbackPage() {
		return getParameter("FeedbackPage");
	}
