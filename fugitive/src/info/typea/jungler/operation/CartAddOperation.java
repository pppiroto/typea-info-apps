 ...
 * created on Sat Jun 30 00:37:06 JST 2007
 * @see info.typea.jungler.generate.AmazonEcsOperationClassGenerator
 * @see info.typea.jungler.generate.OperationClassTemplete
 */
public class CartAddOperation extends Operation {
	/** required fields */
	protected final String[] REQUIRED_FIELDS = {"AssociateTag", "CartId", "HMAC", "Items"};
	/** available ResponseGroups */
	public enum CARTADD_RESPONSEGROUP {Request, Cart, CartSimilarities, CartTopSellers, CartNewReleases};
	/** Constructor */
	public CartAddOperation() {
		setParameter("Operation","CartAdd");
	}
	...
	/** set ResponseGroup */
	public void setResponseGroup(CARTADD_RESPONSEGROUP responseGroup) {
